{
    /* {FORMFIELD.map((item, index) => (
                <div className="input-group" key={index}>
                    {item.map((inputElement) => (
                        <Input
                            key={inputElement.inputId}
                            labelFor={inputElement.labelFor}
                            labelTitle={inputElement.labelTitle}
                            inputType={inputElement.inputType}
                            inputId={inputElement.inputId}
                            inputName={inputElement.inputName}
                            onChangeValue={(e) => handleChange(e.target.value)}
                        />
                    ))}
                </div>
            ))} */
            ...
            <div className="input-group">
                <p>
                    ...
                    <input
                        ...
                        required
                        onChange={(event) =>
                            onChange("initial", event.target.value)
                        }
                    />
                </p>
                <p>
                    ...
                    <input
                        ...
                        onChange={(event) =>
                            onChange("annual", event.target.value)
                        }
                    />
                </p>
            </div>
            <div className="input-group">
                <p>
                    ...
                    <input
                        ...
                        required
                        onChange={(event) =>
                            onChange("expected", event.target.value)
                        }
                    />
                </p>
                <p>
